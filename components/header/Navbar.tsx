    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto flex h-14 items-center justify-between px-4">
        ...
        <div className="flex items-center space-x-4 md:space-x-6">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/admin/menu/create" className="text-sm font-medium hover:underline">
              Admin
            </Link>
          </nav>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden px-4 py-2 border-t bg-background space-y-2">
          <Link href="/menu" className="block text-sm font-medium hover:underline ">
            Menu
          </Link>
          <Link href="/about" className="block text-sm font-medium hover:underline">
            About
          </Link>
          <Link href="/admin/menu/create" className="block text-sm font-medium hover:underline">
            Admin
          </Link>
